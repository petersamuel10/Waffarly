...
public class SuperMarket extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Super_MarketRecyclerView = view.findViewById(R.id.clothesRecyclerView);

        Super_MarketRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        com.example.jesus.waffarly.Adapter.Adapter adapter = new com.example.jesus.waffarly.Adapter.Adapter(Offer.class,
                ...
                databaseReference.orderByChild("categoryId").equalTo("Super Market"));
        adapter.notifyDataSetChanged();

        Super_MarketRecyclerView.setAdapter(adapter);
        return view;
    }
}
